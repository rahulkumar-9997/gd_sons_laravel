...
class ProductsController extends Controller
{
    public function index(Request $request){       
        ...
        $query = Product::select('id','title', 'slug', 'category_id', 'subcategory_id', 'brand_id', 'label_id', 'length', 'breadth', 'height', 'weight', 'volumetric_weight_kg', 'created_at', 'visitor_count', 'product_status')
        ->with(
        ...
        try {
            ...
            if ($request->hasFile('product_images')) {
                ...
                foreach ($files as $key => $file) {
                    ...
                    $image_file_name_webp = 'GD-sons-kitchen-Varanasi-' . $sanitized_title . '-' . $timestamp . '.webp';
                    $image_file_name_jpg = 'GD-sons-kitchen-Varanasi-' . $sanitized_title . '-' . $timestamp . '.jpg';
