        ...
        <div class="col-lg-4">
            <div class="right-side-summery-box">
				...
				<div class="alert alert-warning text-center">
					...
					Currently facing technical issues. Orders are temporarily unavailable.
				</div>

				<button type="submit" class="btn theme-bg-color text-white btn-md w-100 mt-4 fw-bold" disabled style="opacity: 0.6; cursor: not-allowed;">
					Place Order (Temporarily Unavailable)
				</button>
            </div>
        </div>
    </div>
