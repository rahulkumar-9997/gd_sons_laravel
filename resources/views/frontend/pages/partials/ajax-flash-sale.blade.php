                    ...
                    <div class="product-image">
                        ...
                        <div class="product-img">
                            ...
                            <img 
                                ...
                                data-src="{{ asset('images/product/small/'. $firstImage->image_path) }}" 
                                src="{{ asset('frontend/assets/gd-img/product/no-image.png') }}" 
                                srcset="{{ asset('images/product/small/'. $firstImage->image_path) }} 600w, 
                                        {{ asset('images/product/small/'. $firstImage->image_path) }} 1200w"
