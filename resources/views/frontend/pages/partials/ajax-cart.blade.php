                        ...
                        <tr class="product-box-contain">
                                ...
                                <div class="product border-0">
                                    <a href="{{ url('products/'.$cart->slug.'/'.$attributes_value) }}" class="product-image">
                                        ...
                                        <img src="{{ asset('images/product/thumb/' . $cart->images->first()->image_path) }}"
                                            class="img-fluid blur-up lazyload" alt="{{ ucwords(strtolower($cart->title)) }}" loading="lazy">
                                        @else
                            ...
                            <td class="quantity">
                                ...
                                <div class="save-remove product-action d-block-mobile">
                                    <a class="remove close_button remove-cart"
                                    data-productid="{{ $cart->id }}" 
                                    data-url="{{ route('cart.remove', ['productId' => $cart->id]) }}" href="javascript:void(0)">Remove</a>
                                </div>
                            </td>
                            <td class="save-remove product-action d-none-mobile">
                                <h4 class="table-title text-content">Action</h4>
                                <a class="remove close_button remove-cart" data-productid="{{ $cart->id }}" data-url="{{ route('cart.remove', ['productId' => $cart->id]) }}" href="javascript:void(0)">Remove</a>
                            </td>
                        </tr>
                        @endforeach
                    </tbody>
