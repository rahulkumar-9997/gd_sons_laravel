        ...
        <div class="col-xl-12">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <form action="{{ route('additional-filter.update', $additionalFilter->id) }}"
                        method="POST"
                            ...
                            <div class="col-lg-12">
                                <div class="mb-2">
                                    ...
                                    <input type="text"
                                        ...
                                        id="filter_button_name"
                                        class="form-control"
                                        placeholder="Filter Button Name"
                                        value="{{ $additionalFilter->filter_button_name }}">
                                            ...
                                            <div class="d-flex flex-wrap gap-2">
                                                ...
                                                <div class="form-check pt-1 pb-1">
                                                    <input type="checkbox"
                                                        ...
                                                        value="{{ $value->id }}"
                                                        {{ isset($selectedAttributeValues[$attribute->id]) &&
                                                        in_array($value->id, $selectedAttributeValues[$attribute->id])
                                                        ? 'checked'
                                                        : '' }}>
