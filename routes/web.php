...
Route::middleware([TrackVisitor::class])->group(function () {
    ...
    Route::get('bulk-order', [FrontendController::class, 'bulkOrderPage'])->name('bulk.order');
    ...
    Route::post('/ajax/check-shiprocket-locality-details', [CustomerController::class, 'checkLocalityDetails'])->name('ajax.check-shiprocket-locality-details');
...
Route::group(['middleware' => ['admin']], function () {
    ...
    Route::post(
    'shipment-rate-update-weight-category/{id}',
        [ShipmentRateController::class, 'updateShipmentRate']
    )->name('shipment-rate.update-weight-category.store');
