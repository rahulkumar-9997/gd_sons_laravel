...
@section('title','Add Bulk Order Supply')
        ...
        <div class="col-xl-12">
            <div class="card">
                <div class="card-header d-flex justify-content-between align-items-center gap-1">
                    <h4 class="card-title flex-grow-1">Add New Supply</h4>
...
<script>
    $(function() {
        ...
        $('#supplyForm').on('submit', function() {
            $(this).find('button[type="submit"]').prop('disabled', true).html('Saving... <i class="spinner-border spinner-border-sm"></i>');
        });
    });
</script>
@endpush