				...
				if($mrp && $final_offer_rate < $mrp){
					...
					<div class="qtyDetail text-center">
						<div class="qtyField">
							...
							<input type="text" name="quantity" value="{{ $quantity }}" class="qty" readonly>
							<a class="qtyBtn plus"
						...
						<a href="javascript:void(0);" class="remove cartDrawerRemove" data-action="remove" data-id="{{ $item->id }}">
							<i class="fa fa-trash ms-0" data-bs-toggle="tooltip" data-bs-placement="top" title="Remove" aria-label="Remove"></i>
						</a>
					</div>
					</li>
					@endforeach
