...
@endif
	...
	<style>
		...
		.trust-inner.py-2{padding: 0px!important;} .f-category-area .nav-link, .f-customer-services .nav-link, .useful-link .nav-link{padding: .2rem 0.5rem;} .f-category-area ul li, .f-customer-services ul li{display: block;}
	</style>
	@endif