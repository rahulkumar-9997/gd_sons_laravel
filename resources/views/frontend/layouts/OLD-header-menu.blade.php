   ...
   <div class="container">
      <div class="row">
         ...
         <div class="logo col-4 col-sm-4 col-md-4 col-lg-2 align-self-center">
            <a href="{{ url('/') }}">
            <img src="{{asset('frontend/assets/images/avon-logo.svg')}}" alt="Avone Multipurpose Html Template" title="Avone Multipurpose Html Template" />
            </a>
         </div>
         <!--End Desktop Logo-->
            ...
            <nav class="grid__item" id="AccessibleNav">
               <ul id="siteNav" class="site-nav medium center hidearrow">
                  ...
                  @if(!empty($categoriesWithMappedAttributesAndValues))
                     @foreach($categoriesWithMappedAttributesAndValues as $category)
                        <li class="lvl1 parent megamenu">
                              <a href="#">{{ $category['title'] }}<i class="anm anm-angle-down-l"></i></a>
                              <div class="megamenu style4">
                                 @if(!empty($category['attributes']))
                                    <ul class="grid grid--uniform mmWrapper">
                                          @foreach($category['attributes'] as $attributeTitle => $values)
                                             <li class="grid__item lvl-1 col-md-3 col-lg-3">
                                                <a href="#" class="site-nav lvl-1 menu-title">{{ $attributeTitle }}</a>
                                                <ul class="subLinks">
                                                      @foreach($values as $value)
                                                      <li class="lvl-2">
                                                         <a href="{{ url('product-catalog/' . $category['slug'] . '/' . Str::slug($attributeTitle) . '/' . $value['slug']) }}" class="site-nav lvl-2">{{ $value['name'] }}</a>
                                                      </li>
                                                      @endforeach
                                                </ul>
                                             </li>
                                 ...
                                 @endif
                                 <div class="row clear">
                                    <div class="col-md-4 col-lg-4"><a href="#"><img src="assets/images/megamenu-banner4.jpg" alt=""/></a></div>
                                    <div class="col-md-4 col-lg-4"><a href="#"><img src="assets/images/megamenu-banner5.jpg" alt=""/></a></div>
                                    <div class="col-md-4 col-lg-4"><a href="#"><img src="assets/images/megamenu-banner6.jpg" alt=""/></a></div>
                                 </div>
                              </div>
                        </li>
                     @endforeach
                  ...
                  <li class="lvl1 parent dropdown">
                     <a href="#">Lookbook <i class="anm anm-angle-down-l"></i></a>
                     <ul class="dropdown">
                  ...
                  <li class="lvl1 parent dropdown">
                     ...
                     <ul class="dropdown">
                        ...
                        <li>
                           <a href="aboutus-style1.html" class="site-nav">About Us <i class="anm anm-angle-right-l"></i></a>
                           <ul class="dropdown">
                        ...
                        <li>
                           <a href="contact-style1.html" class="site-nav">Contact Us <i class="anm anm-angle-right-l"></i></a>
                           <ul class="dropdown">
                        ...
                        <li>
                           <a href="faqs-style1.html" class="site-nav">FAQs <i class="anm anm-angle-right-l"></i></a>
                           <ul class="dropdown">
...
<div class="mobile-nav-wrapper" role="navigation">
   ...
   <ul id="MobileNav" class="mobile-nav">
      <li class="lvl1 parent megamenu">
         ...
         <ul>
            <li>
               <a href="#" class="site-nav">Homepages<i class="anm anm-plus-l"></i></a>
               <ul>
      ...
      <li class="lvl1 parent megamenu">
         ...
         <ul>
            <li>
               <a href="#" class="site-nav">Category Page<i class="anm anm-plus-l"></i></a>
               <ul>
            ...
            <li>
               <a href="#" class="site-nav">Shop Page<i class="anm anm-plus-l"></i></a>
               <ul>
            ...
            <li>
               <a href="#" class="site-nav">Shop Other Page<i class="anm anm-plus-l"></i></a>
               <ul>
      ...
      <li class="lvl1 parent megamenu">
         <a href="product-layout1.html">Product <i class="anm anm-plus-l"></i></a>
         <ul>
            <li>
               <a href="product-layout1.html" class="site-nav">Product Page<i class="anm anm-plus-l"></i></a>
               <ul>
            ...
            <li>
               <a href="short-description.html" class="site-nav">Product Page Types <i class="anm anm-plus-l"></i></a>
               <ul>
      ...
      <li class="lvl1 parent megamenu">
         <a href="#">Lookbook <i class="anm anm-plus-l"></i></a>
         <ul>
            <li><a href="lookbook-2columns.html" class="site-nav">2 Columns</a></li>
            <li><a href="lookbook-3columns.html" class="site-nav">3 Columns</a></li>
            <li><a href="lookbook-4columns.html" class="site-nav">4 Columns</a></li>
      ...
      <li class="lvl1 parent megamenu">
         ...
         <ul>
            ...
            <li>
               <a href="faqs-style1.html" class="site-nav">FAQs <i class="anm anm-plus-l"></i></a>
               <ul class="dropdown">
                  <li><a href="faqs-style1.html" class="site-nav">FAQs Style1</a></li>
                  <li><a href="faqs-style2.html" class="site-nav">FAQs Style2</a></li>
               </ul>
