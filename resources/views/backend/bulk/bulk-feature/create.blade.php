...
@section('title','Add Bulk Featured Product')
      ...
      <div class="col-xl-12">
         <div class="card">
            <div class="card-header d-flex justify-content-between align-items-center gap-1">
               <h4 class="card-title flex-grow-1">Add Bulk Featured Product</h4>
            ...
            <div class="card-body">
               ...
               <form action="{{ route('bulk-featured-products.store') }}" method="POST" id="bulkFeaturedForm">
                  @csrf
                        ...
                        <div class="position-relative">
                           <div class="input-group">
                              <input type="text" name="product_name" class="form-control product-autocomplete"
                                     placeholder="Type product name" value="{{ old('product_name') }}" required>
                           ...
                           <input type="hidden" name="product_id" class="product_id" value="{{ old('product_id') }}">
                        </div>
                     </div>

                     <div class="col-md-3">
                        <label class="form-label">Bulk Rate (₹) <span class="text-danger">*</span></label>
                        <input type="number" step="0.01" name="bulk_rate" class="form-control" value="{{ old('bulk_rate') }}" required>
                     </div>

                     <div class="col-md-3">
                        <label class="form-label">Min Qty (pcs) <span class="text-danger">*</span></label>
                        <input type="number" name="min_qty" class="form-control" value="{{ old('min_qty') }}" required>
                     </div>
